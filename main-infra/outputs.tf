...
# Note: Aurora outputs removed as we're using RDS PostgreSQL instead of Aurora
# If you need Aurora in the future, uncomment these outputs and add the corresponding module
